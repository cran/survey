...
Ratios=
                              as.numeric(age > 36)
I(rel * as.numeric(age > 36))             0.167946
SEs=
                              as.numeric(age > 36)
I(rel * as.numeric(age > 36))           0.01044728
\end{Soutput}
\begin{Sinput}
...
Coefficients:
                 Estimate Std. Error t value Pr(>|t|)    
I(age > 36)FALSE 0.112839   0.008717   12.94   <2e-16 ***
I(age > 36)TRUE  0.167946   0.010447   16.08   <2e-16 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1 

(Dispersion parameter for gaussian family taken to be 0.121011)
