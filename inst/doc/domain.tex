...
Ratios=
                              as.numeric(age > 36)
I(rel * as.numeric(age > 36))            0.1944813
SEs=
                              as.numeric(age > 36)
I(rel * as.numeric(age > 36))           0.01280461
\end{Soutput}
\begin{Sinput}
...
Coefficients:
                 Estimate Std. Error t value Pr(>|t|)    
I(age > 36)FALSE 0.098065   0.007335   13.37   <2e-16 ***
I(age > 36)TRUE  0.194481   0.012805   15.19   <2e-16 ***
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 

(Dispersion parameter for gaussian family taken to be 0.1194641)
