...
Ratios=
                              as.numeric(age > 36)
I(rel * as.numeric(age > 36))            0.1634315
SEs=
                              as.numeric(age > 36)
I(rel * as.numeric(age > 36))           0.01003741
\end{Soutput}
\begin{Sinput}
...
Coefficients:
                 Estimate Std. Error t value Pr(>|t|)    
I(age > 36)FALSE 0.116390   0.009038   12.88   <2e-16 ***
I(age > 36)TRUE  0.163432   0.010037   16.28   <2e-16 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1 

(Dispersion parameter for gaussian family taken to be 0.1212182)
