...
svycoxph.svyrep.design(formula = Surv(start, stop, event) ~ factor(stage) + 
    factor(histol) + I(age/12), design = dWacholder)
                  ...
                  coef exp(coef) se(coef)    z       p
factor(stage)2  0.7359      2.09   0.1810 4.07 4.8e-05
factor(stage)3  0.5976      1.82   0.1880 3.18 1.5e-03
factor(stage)4  1.3907      4.02   0.2156 6.45 1.1e-10
factor(histol)2 1.5045      4.50   0.1811 8.31 1.1e-16
I(age/12)       0.0432      1.04   0.0262 1.65 1.0e-01
