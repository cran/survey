...
svycoxph(Surv(start, stop, event) ~ factor(stage) + factor(histol) + 
    I(age/12), design = dWacholder)
                  ...
                  coef exp(coef) se(coef)    z       p
factor(stage)2  0.7359      2.09   0.1726 4.26 2.0e-05
factor(stage)3  0.5976      1.82   0.1789 3.34 8.4e-04
factor(stage)4  1.3907      4.02   0.1999 6.96 3.5e-12
factor(histol)2 1.5045      4.50   0.1751 8.59 0.0e+00
I(age/12)       0.0432      1.04   0.0254 1.70 9.0e-02
