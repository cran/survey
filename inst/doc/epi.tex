...
svycoxph(Surv(start, stop, event) ~ factor(stage) + factor(histol) + 
    I(age/12), design = dWacholder)
                  ...
                  coef exp(coef) se(coef)    z       p
factor(stage)2  0.7359      2.09   0.1655 4.45 8.7e-06
factor(stage)3  0.5976      1.82   0.1761 3.39 6.9e-04
factor(stage)4  1.3907      4.02   0.2276 6.11 9.9e-10
factor(histol)2 1.5045      4.50   0.1729 8.70 0.0e+00
I(age/12)       0.0432      1.04   0.0259 1.67 9.6e-02
