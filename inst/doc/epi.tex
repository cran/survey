...
svycoxph.svyrep.design(formula = Surv(start, stop, event) ~ factor(stage) + 
    factor(histol) + I(age/12), design = dWacholder)
                  ...
                  coef exp(coef) se(coef)    z       p
factor(stage)2  0.7359      2.09   0.1614 4.56 5.2e-06
factor(stage)3  0.5976      1.82   0.1756 3.40 6.7e-04
factor(stage)4  1.3907      4.02   0.2123 6.55 5.7e-11
factor(histol)2 1.5045      4.50   0.1669 9.02 0.0e+00
I(age/12)       0.0432      1.04   0.0255 1.69 9.0e-02
