...
svycoxph(Surv(start, stop, event) ~ factor(stage) + factor(histol) + 
    I(age/12), design = dWacholder)
                  ...
                  coef exp(coef) se(coef)    z       p
factor(stage)2  0.7359      2.09   0.1846 3.99 6.7e-05
factor(stage)3  0.5976      1.82   0.1838 3.25 1.1e-03
factor(stage)4  1.3907      4.02   0.2146 6.48 9.1e-11
factor(histol)2 1.5045      4.50   0.1693 8.89 0.0e+00
I(age/12)       0.0432      1.04   0.0248 1.74 8.2e-02
